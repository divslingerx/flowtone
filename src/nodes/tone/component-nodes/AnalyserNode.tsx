...
export function AnalyserNode({ data, id }: NodeProps<AnalyserNode>) {
  const _analyser = useToneNode(data.type, data.config);
  const portConfig = getPortConfigForNode("Analyser");
